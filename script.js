...
function setSpace(){
  const inputs = document.getElementById("formVals").elements;
  var x1 = inputs["x1"].value;
  var x2 = inputs["x2"].value;
  var y1 = inputs["y1"].value;
  var y2 = inputs["y2"].value;
  var algorithm = inputs["algoSelection"].value;
  var lenSpace = inputs["lenSpace"].value;
  console.log(x1);
